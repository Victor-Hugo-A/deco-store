...
export async function sendAccountEmail({ to, url, kind }: AccountEmail) {
  ...
  const title = verification ? "Confirme seu e-mail na DECO" : "Redefina sua senha na DECO";
